...
describe(NAME, function () {
    ...
    describe("exploit", async function () {
        ...
        it("conduct your attack here", async function () {
            ...
            attackerContract = await AttackerContract.deploy(victimContract.address);
            await attackerContract.deployed();          

            await attackerContract.connect(attackerWallet).attackFunc({ value: ethers.utils.parseEther("1") });
